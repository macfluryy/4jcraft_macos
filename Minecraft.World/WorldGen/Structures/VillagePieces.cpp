...
VillagePieces::Well::Well(StartPiece* startPiece, int genDepth, Random* random,
                          int west, int north)
    : VillagePiece(startPiece, genDepth), isSource(true) {
...
VillagePieces::Well::Well(StartPiece* startPiece, int genDepth, Random* random,
    ...
    : VillagePiece(startPiece, genDepth), isSource(false) {
    heightPosition = -1;  // 4J added initialiser
...
// VillagePieces::Well
// *VillagePieces::Well::createPiece(std::list<StructurePiece *> *pieces, Random
// *random, int footX, int footY, int footZ, int direction, int genDepth)
//{
//     BoundingBox *box = BoundingBox::orientBox(footX, footY, footZ, -1, 4 -
//     height, 0, width, height, depth, direction);
//
//     if (!isOkBox(box) || StructurePiece::findCollisionPiece(pieces, box) !=
//     NULL)
//	{
//		delete box;
//         return NULL;
...
bool VillagePieces::Well::postProcess(Level* level, Random* random,
    ...
    generateBox(level, chunkBB, 1, 0, 1, 4, height - 3, 4, Tile::stoneBrick_Id,
                Tile::water_Id, false);
    ...
    generateBox(level, chunkBB, 1, height, 1, 4, height, 4, Tile::stoneBrick_Id,
...
VillagePieces::StartPiece::StartPiece(BiomeSource* biomeSource, int genDepth,
    ...
    this->isDesertVillage =
        biome == Biome::desert || biome == Biome::desertHills;
...
bool VillagePieces::SimpleHouse::postProcess(Level* level, Random* random,
    ...
    // floor
    generateBox(level, chunkBB, 0, 0, 0, 4, 0, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // roof
...
bool VillagePieces::SmallTemple::postProcess(Level* level, Random* random,
    ...
    // floor
    generateBox(level, chunkBB, 1, 0, 0, 3, 0, 8, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);

    // front wall
    generateBox(level, chunkBB, 1, 1, 0, 3, 10, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // left tall wall
    generateBox(level, chunkBB, 0, 1, 1, 0, 10, 3, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // right tall wall
    generateBox(level, chunkBB, 4, 1, 1, 4, 10, 3, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // left low wall
    generateBox(level, chunkBB, 0, 0, 4, 0, 4, 7, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // right low wall
    generateBox(level, chunkBB, 4, 0, 4, 4, 4, 7, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // far low wall
    generateBox(level, chunkBB, 1, 1, 8, 3, 4, 8, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // far upper wall
    generateBox(level, chunkBB, 1, 5, 4, 3, 10, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);

    // low roof
    generateBox(level, chunkBB, 1, 5, 5, 3, 5, 7, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // high roof
    generateBox(level, chunkBB, 0, 9, 0, 4, 9, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // middle floor / roof
    generateBox(level, chunkBB, 0, 4, 0, 4, 4, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
...
bool VillagePieces::BookHouse::postProcess(Level* level, Random* random,
    ...
    // floor
    generateBox(level, chunkBB, 0, 0, 0, 8, 0, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    // roof
    generateBox(level, chunkBB, 0, 5, 0, 8, 5, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 0, 6, 1, 8, 6, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 0, 7, 2, 8, 7, 3, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    ...
    // rock supports
    generateBox(level, chunkBB, 0, 1, 0, 0, 1, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 1, 1, 5, 8, 1, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 8, 1, 0, 8, 1, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 2, 1, 0, 7, 1, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 0, 2, 0, 0, 4, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 0, 2, 5, 0, 4, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 8, 2, 5, 8, 4, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 8, 2, 0, 8, 4, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
...
bool VillagePieces::SmallHut::postProcess(Level* level, Random* random,
    ...
    // floor
    generateBox(level, chunkBB, 0, 0, 0, 3, 0, 4, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
...
bool VillagePieces::PigHouse::postProcess(Level* level, Random* random,
    ...
    generateBox(level, chunkBB, 1, 0, 1, 7, 0, 4, Tile::wood_Id, Tile::wood_Id,
                false);
    generateBox(level, chunkBB, 0, 0, 0, 0, 3, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 8, 0, 0, 8, 3, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 1, 0, 0, 7, 1, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 1, 0, 5, 7, 1, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
...
bool VillagePieces::TwoRoomHouse::postProcess(Level* level, Random* random,
    ...
    generateBox(level, chunkBB, 0, 0, 0, 0, 3, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 8, 0, 0, 8, 3, 10, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 1, 0, 0, 7, 2, 0, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 1, 0, 5, 2, 1, 5, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 2, 0, 6, 2, 3, 10, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    generateBox(level, chunkBB, 3, 0, 10, 7, 3, 10, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
...
bool VillagePieces::Smithy::postProcess(Level* level, Random* random,
    ...
    // floor
    generateBox(level, chunkBB, 0, 0, 0, 9, 0, 6, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);

    // roof
    generateBox(level, chunkBB, 0, 4, 0, 9, 4, 6, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
    ...
    // furnace
    generateBox(level, chunkBB, 6, 1, 4, 9, 4, 6, Tile::stoneBrick_Id,
                Tile::stoneBrick_Id, false);
