...
int Spider::getMaxHealth() { return 16; }

double Spider::getRideHeight() { return bbHeight * 0.75 - 0.5f; }

bool Spider::makeStepSound() { return false; }
...
float Spider::getModelScale() { return 1.0f; }
