...
public:
    ...
    public:
        ...
        virtual void save(CompoundTag* tag) {
            ...
            // return true;	// 4J - TODO, in java there is no return type
            // here but we can't change our derived class member function to not
            // have one - investigate 4J Jev, took out the return statement,
            // TileEntity::save is now virtual. Think this fixes above.
        }

        // 4J Added
        std::shared_ptr<TileEntity> clone() {
            std::shared_ptr<RecordPlayerTile::Entity> result =
                std::shared_ptr<RecordPlayerTile::Entity>(
