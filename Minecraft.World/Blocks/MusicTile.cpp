...
MusicTile::MusicTile(int id) : EntityTile(id, Material::wood) {}
...
bool MusicTile::TestUse() { return true; }

bool MusicTile::use(Level* level, int x, int y, int z,
...
void MusicTile::attack(Level* level, int x, int y, int z,
...
void MusicTile::triggerEvent(Level* level, int x, int y, int z, int i,
                             int note) {
