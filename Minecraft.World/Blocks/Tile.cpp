...
void Tile::staticCtor() {
    ...
    Tile::lapisBlock = (new Tile(22, Material::stone))
                           ...
                           ->setTextureName(L"blockLapis")
                           ->setDescriptionId(IDS_TILE_BLOCK_LAPIS)
                           ->setUseDescriptionId(IDS_DESC_BLOCK_LAPIS);
    Tile::musicBlock = (new MusicTile(25))
                           ->setDestroyTime(0.8f)
                           ->setTextureName(L"musicBlock")
    ...
    Tile::glass = (new GlassTile(20, Material::glass, false))
                      ...
                      ->setTextureName(L"glass")
                      ->setDescriptionId(IDS_TILE_GLASS)
                      ->setUseDescriptionId(IDS_DESC_GLASS);
    Tile::dispenser = (new DispenserTile(23))
                          ->setDestroyTime(3.5f)
                          ->setSoundType(Tile::SOUND_STONE)
                          ->setTextureName(L"dispenser")
                          ->setDescriptionId(IDS_TILE_DISPENSER)
                          ->sendTileData()
                          ->setUseDescriptionId(IDS_DESC_DISPENSER);

    // Tile::wood = (new Tile(5, 4, Material::wood))
    // ->setBaseItemTypeAndMaterial(Item::eBaseItemType_structwoodstuff,
    // Item::eMaterial_wood)->setDestroyTime(2.0f)->setExplodeable(5)->setSoundType(Tile::SOUND_WOOD)->setDescriptionId(IDS_TILE_WOOD)->sendTileData()->setUseDescriptionId(IDS_DESC_WOODENPLANKS);
    Tile::wood =
        (new WoodTile(5))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_structwoodstuff,
                                         Item::eMaterial_wood)
    ...
    Tile::pistonStickyBase =
        (PistonBaseTile*)(new PistonBaseTile(29, true))
            ...
            ->setTextureName(L"pistonStickyBase")
    ...
    Tile::rose = (Bush*)(new Bush(38))
                     ->setDestroyTime(0.0f)
                     ->setSoundType(Tile::SOUND_GRASS)
                     ->setTextureName(L"rose")
                     ->setDescriptionId(IDS_TILE_ROSE)
                     ->setUseDescriptionId(IDS_DESC_FLOWER)
                     ->disableMipmap();
    Tile::mushroom1 = (Bush*)(new Mushroom(39, L"mushroom_brown"))
                          ->setDestroyTime(0.0f)
                          ->setSoundType(Tile::SOUND_GRASS)
                          ->setLightEmission(2 / 16.0f)
                          ->setTextureName(L"mushroom")
                          ->setDescriptionId(IDS_TILE_MUSHROOM)
                          ->setUseDescriptionId(IDS_DESC_MUSHROOM)
                          ->disableMipmap();
    Tile::mushroom2 = (Bush*)(new Mushroom(40, L"mushroom_red"))
                          ->setDestroyTime(0.0f)
                          ->setSoundType(Tile::SOUND_GRASS)
                          ->setTextureName(L"mushroom")
                          ->setDescriptionId(IDS_TILE_MUSHROOM)
    ...
    // 	Tile::stoneSlab = (new StoneSlabTile(43, true))
    // ->setBaseItemTypeAndMaterial(Item::eBaseItemType_slab,
    // Item::eMaterial_stone)->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setDescriptionId(IDS_TILE_STONESLAB)->setUseDescriptionId(IDS_DESC_SLAB);
    // 	Tile::stoneSlabHalf = (new StoneSlabTile(44, false))
    // ->setBaseItemTypeAndMaterial(Item::eBaseItemType_halfslab,
    // Item::eMaterial_stone)->setDestroyTime(2.0f)->setExplodeable(10)->setSoundType(Tile::SOUND_STONE)->setDescriptionId(IDS_TILE_STONESLAB)->setUseDescriptionId(IDS_DESC_HALFSLAB);

    Tile::tnt = (new TntTile(46))
                    ->setDestroyTime(0.0f)
                    ->setSoundType(Tile::SOUND_GRASS)
                    ->setTextureName(L"tnt")
                    ->setDescriptionId(IDS_TILE_TNT)
                    ->setUseDescriptionId(IDS_DESC_TNT);
    Tile::bookshelf = (new BookshelfTile(47))
                          ->setDestroyTime(1.5f)
                          ->setSoundType(Tile::SOUND_WOOD)
                          ->setTextureName(L"bookshelf")
                          ->setDescriptionId(IDS_TILE_BOOKSHELF)
                          ->setUseDescriptionId(IDS_DESC_BOOKSHELF);
    Tile::mossStone = (new Tile(48, Material::stone))
                          ->setDestroyTime(2.0f)
                          ->setExplodeable(10)
                          ->setSoundType(Tile::SOUND_STONE)
                          ->setTextureName(L"stoneMoss")
                          ->setDescriptionId(IDS_TILE_STONE_MOSS)
                          ->setUseDescriptionId(IDS_DESC_MOSS_STONE);
    // 4J - change of destroy time from 10.0f -> 50.0f for obsidian brought
    // forward from 1.2.3
    ...
    Tile::redStoneOre_lit = (new RedStoneOreTile(74, true))
                                ...
                                ->sendTileData()
                                ->setUseDescriptionId(IDS_DESC_ORE_REDSTONE);
    Tile::notGate_off = (new NotGateTile(75, false))
                            ->setDestroyTime(0.0f)
                            ->setSoundType(Tile::SOUND_WOOD)
                            ->setTextureName(L"notGate")
                            ->setDescriptionId(IDS_TILE_NOT_GATE)
                            ->sendTileData()
                            ->setUseDescriptionId(IDS_DESC_REDSTONETORCH)
                            ->disableMipmap();
    Tile::notGate_on = (new NotGateTile(76, true))
                           ->setDestroyTime(0.0f)
    ...
    Tile::diode_off = (RepeaterTile*)(new DiodeTile(93, false))
                          ->setDestroyTime(0.0f)
                          ->setSoundType(Tile::SOUND_WOOD)
                          ->setTextureName(L"diode")
                          ->setDescriptionId(IDS_ITEM_DIODE)
                          ->setNotCollectStatistics()
                          ->sendTileData()
                          ->setUseDescriptionId(IDS_DESC_REDSTONEREPEATER)
                          ->disableMipmap();
    Tile::diode_on = (RepeaterTile*)(new DiodeTile(94, true))
                         ->setDestroyTime(0.0f)
                         ->setLightEmission(10 / 16.0f)
                         ->setSoundType(Tile::SOUND_WOOD)
                         ->setTextureName(L"diode")
                         ...
                         ->setUseDescriptionId(IDS_DESC_REDSTONEREPEATER)
                         ->disableMipmap();
    Tile::aprilFoolsJoke = (new LockedChestTile(95))
                               ->setDestroyTime(0.0f)
                               ->setLightEmission(16 / 16.0f)
                               ->setSoundType(Tile::SOUND_WOOD)
                               ->setTextureName(L"lockedchest")
                               ->setDescriptionId(IDS_TILE_LOCKED_CHEST)
                               ->setTicking(true)
                               ->sendTileData()
                               ->setUseDescriptionId(-1);
    ...
    Tile::monsterStoneEgg =
        (new StoneMonsterTile(97))
            ...
            ->setTextureName(L"monsterStoneEgg")
    ...
    Tile::stoneBrickSmooth =
        (new SmoothStoneBrickTile(98))
            ...
            ->setTextureName(L"stonebricksmooth")
            ->setDescriptionId(IDS_TILE_STONE_BRICK_SMOOTH)
            ->setUseDescriptionId(IDS_DESC_STONE_BRICK_SMOOTH);
    Tile::hugeMushroom1 = (new HugeMushroomTile(99, Material::wood, 0))
                              ->setDestroyTime(0.2f)
                              ...
                              ->setUseDescriptionId(IDS_DESC_MUSHROOM)
                              ->sendTileData();
    Tile::hugeMushroom2 = (new HugeMushroomTile(100, Material::wood, 1))
                              ->setDestroyTime(0.2f)
                              ->setSoundType(SOUND_WOOD)
                              ->setTextureName(L"mushroom")
                              ...
                              ->setUseDescriptionId(IDS_DESC_MUSHROOM)
                              ->sendTileData();
    Tile::ironFence = (new ThinFenceTile(101, L"fenceIron", L"fenceIron",
                                         Material::metal, true))
                          ->setBaseItemTypeAndMaterial(
    ...
    Tile::stairs_wood =
        (new StairTile(53, Tile::wood, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_wood)
            ->setTextureName(L"stairsWood")
            ->setDescriptionId(IDS_TILE_STAIRS_WOOD)
            ->sendTileData()
            ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::stairs_stone =
        (new StairTile(67, Tile::stoneBrick, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_stone)
            ->setTextureName(L"stairsStone")
    ...
    Tile::stairs_bricks =
        (new StairTile(108, Tile::redBrick, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_brick)
            ->setTextureName(L"stairsBrick")
            ->setDescriptionId(IDS_TILE_STAIRS_BRICKS)
            ->sendTileData()
            ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::stairs_stoneBrickSmooth =
        (new StairTile(109, Tile::stoneBrickSmooth, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_stoneSmooth)
            ->setTextureName(L"stairsStoneBrickSmooth")
    ...
    Tile::netherBrick =
        (new Tile(112, Material::stone))
            ...
            ->setExplodeable(10)
            ->setSoundType(SOUND_STONE)
            ->setTextureName(L"netherBrick")
            ->setDescriptionId(IDS_TILE_NETHERBRICK)
            ->setUseDescriptionId(IDS_DESC_NETHERBRICK);
    Tile::netherFence =
        (new FenceTile(113, L"netherBrick", Material::stone))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_fence,
                                         Item::eMaterial_netherbrick)
            ->setDestroyTime(2.0f)
            ->setExplodeable(10)
            ->setSoundType(SOUND_STONE)
            ->setTextureName(L"netherFence")
    ...
    Tile::stairs_netherBricks =
        (new StairTile(114, Tile::netherBrick, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_netherbrick)
            ->setTextureName(L"stairsNetherBrick")
            ->setDescriptionId(IDS_TILE_STAIRS_NETHERBRICK)
            ->sendTileData()
            ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::netherStalk = (new NetherStalkTile(115))
                            ->setTextureName(L"netherStalk")
    ...
    Tile::enchantTable =
        (new EnchantmentTableTile(116))
            ...
            ->setDestroyTime(5.0f)
            ->setExplodeable(2000)
            ->setTextureName(L"enchantmentTable")
    ...
    Tile::endPortalFrameTile =
        (new TheEndPortalFrameTile(120))
            ...
            ->setLightEmission(2 / 16.0f)
            ->setDestroyTime(INDESTRUCTIBLE_DESTROY_TIME)
            ->setTextureName(L"endPortalFrame")
            ->setDescriptionId(IDS_TILE_ENDPORTALFRAME)
            ->sendTileData()
            ->setExplodeable(6000000)
            ->setUseDescriptionId(IDS_DESC_ENDPORTALFRAME);
    Tile::whiteStone = (new Tile(121, Material::stone))
                           ->setDestroyTime(3.0f)
                           ->setExplodeable(15)
                           ->setSoundType(SOUND_STONE)
                           ->setTextureName(L"whiteStone")
    ...
    Tile::stairs_sandstone =
        (new StairTile(128, Tile::sandStone, 0))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_stairs,
                                         Item::eMaterial_sand)
            ->setTextureName(L"stairsSandstone")
    ...
    Tile::woodStairsBirch =
        (new StairTile(135, Tile::wood, TreeTile::BIRCH_TRUNK))
            ...
            ->setTextureName(L"stairsWoodBirch")
    ...
    Tile::woodStairsJungle =
        (new StairTile(136, Tile::wood, TreeTile::JUNGLE_TRUNK))
            ...
            ->setTextureName(L"stairsWoodJungle")
            ->setDescriptionId(IDS_TILE_STAIRS_JUNGLEWOOD)
            ->sendTileData()
            ->setUseDescriptionId(IDS_DESC_STAIRS);
    Tile::button_wood =
        (new ButtonTile(143, true))
            ->setBaseItemTypeAndMaterial(Item::eBaseItemType_button,
                                         Item::eMaterial_wood)
            ->setDestroyTime(0.5f)
            ->setSoundType(Tile::SOUND_WOOD)
    ...
    Item::items[Tile::cloth_Id] = (new ClothTileItem(Tile::cloth_Id - 256))
                                      ...
                                      ->setDescriptionId(IDS_TILE_CLOTH)
                                      ->setUseDescriptionId(IDS_DESC_WOOL);
    Item::items[Tile::woolCarpet_Id] =
        (new ClothTileItem(Tile::woolCarpet_Id - 256))
            ->setTextureName(L"woolCarpet")
            ->setDescriptionId(IDS_TILE_CARPET)
            ->setUseDescriptionId(IDS_DESC_CARPET);
    Item::items[Tile::treeTrunk_Id] =
        (new TreeTileItem(Tile::treeTrunk_Id - 256, treeTrunk))
            ->setTextureName(L"log")
            ->setDescriptionId(IDS_TILE_LOG)
            ->setUseDescriptionId(IDS_DESC_LOG);
    Item::items[Tile::wood_Id] =
        (new MultiTextureTileItem(Tile::wood_Id - 256, Tile::wood,
                                  (int*)WoodTile::WOOD_NAMES, 4))
            ->setTextureName(L"wood")
            ->setDescriptionId(IDS_TILE_OAKWOOD_PLANKS)
            ->setUseDescriptionId(IDS_DESC_LOG);  //  <- TODO
    Item::items[Tile::monsterStoneEgg_Id] =
        (new StoneMonsterTileItem(Tile::monsterStoneEgg_Id - 256))
            ->setTextureName(L"monsterStoneEgg")
            ->setDescriptionId(IDS_TILE_STONE_SILVERFISH)
            ->setUseDescriptionId(
                IDS_DESC_STONE_SILVERFISH);  // 4J - Brought forward from
                                             // post-1.2 to fix stacking problem
    Item::items[Tile::stoneBrickSmooth_Id] =
        (new SmoothStoneBrickTileItem(Tile::stoneBrickSmooth_Id - 256,
                                      stoneBrickSmooth))
            ->setTextureName(L"stonebricksmooth")
            ->setDescriptionId(IDS_TILE_STONE_BRICK_SMOOTH);
    Item::items[Tile::sandStone_Id] =
        (new MultiTextureTileItem(sandStone_Id - 256, sandStone,
            ...
            ->setDescriptionId(IDS_TILE_SANDSTONE)
            ->setUseDescriptionId(IDS_DESC_SANDSTONE);
    Item::items[Tile::quartzBlock_Id] =
...
float Tile::getBrightness(LevelSource* level, int x, int y, int z) {
    ...
    return level->getBrightness(x, y, z,
                                Tile::lightEmission[level->getTile(x, y, z)]);
}
...
int Tile::getLightColor(LevelSource* level, int x, int y, int z,
    ...
    if (tileId == -1) {
        return level->getLightColor(
            x, y, z, Tile::lightEmission[level->getTile(x, y, z)], -1);
    } else {
        return level->getLightColor(x, y, z, Tile::lightEmission[tileId],
                                    tileId);
    }
}
...
int Tile::getTickDelay() { return 10; }
...
bool Tile::getSignal(LevelSource* level, int x, int y, int z) { return false; }
