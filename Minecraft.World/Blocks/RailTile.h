...
private:
    ...
    bool findGoldenRailSignal(Level* level, int x, int y, int z, int data,
                              bool forward, int searchDepth);
    bool isGoldenRailWithPower(Level* level, int x, int y, int z, bool forward,
                               int searchDepth, int dir);
