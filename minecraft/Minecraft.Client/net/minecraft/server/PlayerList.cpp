...
#include "Minecraft.Client/net/minecraft/server/level/ServerPlayerGameMode.h"
#include "Minecraft.Client/net/minecraft/server/network/ServerConnection.h"
#include "Minecraft.Client/net/minecraft/server/network/PendingConnection.h"
...
#include "minecraft/world/level/storage/net.minecraft.world.level.storage.h"
#include "minecraft/world/level/saveddata/net.minecraft.world.level.saveddata.h"
