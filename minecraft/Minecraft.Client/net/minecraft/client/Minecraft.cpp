...
#include "Minecraft.Client/net/minecraft/server/level/SurvivalMode.h"
#include "Minecraft.Client/net/minecraft/client/renderer/Chunk.h"
#include "Minecraft.Client/net/minecraft/server/level/CreativeMode.h"
#include "Minecraft.Client/net/minecraft/client/level/DemoLevel.h"
...
#include "Minecraft.Client/net/minecraft/client/gui/DeathScreen.h"
#include "Minecraft.Client/net/minecraft/client/gui/ErrorScreen.h"
#include "Minecraft.Client/net/minecraft/client/title/TitleScreen.h"
#include "Minecraft.Client/net/minecraft/client/gui/inventory/InventoryScreen.h"
#if defined(ENABLE_JAVA_GUIS)
#include "Minecraft.Client/net/minecraft/client/gui/inventory/CreativeInventoryScreen.h"
#endif
#include "Minecraft.Client/net/minecraft/client/gui/InBedChatScreen.h"
#include "Minecraft.Client/net/minecraft/client/gui/achievement/AchievementPopup.h"
#include "Minecraft.Client/net/minecraft/client/player/Input.h"
...
#include "Minecraft.Client/net/minecraft/client/renderer/texture/TextureManager.h"
#include "Minecraft.Client/Common/src/UI/All Platforms/IUIScene_CreativeMenu.h"
#include "Minecraft.Client/Common/src/UI/UIFontData.h"
