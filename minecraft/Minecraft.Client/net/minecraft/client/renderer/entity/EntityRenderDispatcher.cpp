...
#include "Minecraft.World/net/minecraft/world/entity/global/net.minecraft.world.entity.global.h"
...
#include "Minecraft.Client/net/minecraft/client/model/PigModel.h"
#include "Minecraft.Client/net/minecraft/client/model/SheepModel.h"
#include "Minecraft.Client/net/minecraft/client/model/CowModel.h"
#include "Minecraft.Client/net/minecraft/client/model/WolfModel.h"
#include "Minecraft.Client/net/minecraft/client/model/ChickenModel.h"
#include "Minecraft.Client/net/minecraft/client/model/CreeperModel.h"
#include "Minecraft.Client/net/minecraft/client/model/SlimeModel.h"
#include "Minecraft.Client/net/minecraft/client/model/GhastModel.h"
#include "Minecraft.Client/net/minecraft/client/model/SquidModel.h"
#include "Minecraft.Client/net/minecraft/client/model/MinecartModel.h"
#include "Minecraft.Client/net/minecraft/client/model/BoatModel.h"
#include "Minecraft.Client/net/minecraft/client/model/HumanoidModel.h"
#include "Minecraft.Client/net/minecraft/client/model/SheepFurModel.h"
#include "Minecraft.Client/net/minecraft/client/model/SkeletonModel.h"
#include "Minecraft.Client/net/minecraft/client/model/ModelHorse.h"
...
#include "Minecraft.Client/net/minecraft/client/model/OcelotModel.h"
