    ...
    LEADERBOARD_DESCRIPTORS[UIScene_LeaderboardsMenu::NUM_LEADERBOARDS][4] = {
        {
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                4, true,
                IDS_LEADERBOARD_TRAVELLING_PEACEFUL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                4, true, IDS_LEADERBOARD_TRAVELLING_EASY),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                4, true,
                IDS_LEADERBOARD_TRAVELLING_NORMAL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                4, true, IDS_LEADERBOARD_TRAVELLING_HARD),  
        },
        {
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false,
                IDS_LEADERBOARD_MINING_BLOCKS_PEACEFUL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false, IDS_LEADERBOARD_MINING_BLOCKS_EASY),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false,
                IDS_LEADERBOARD_MINING_BLOCKS_NORMAL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false, IDS_LEADERBOARD_MINING_BLOCKS_HARD),  
        },
        {
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                6, false,
                IDS_LEADERBOARD_FARMING_PEACEFUL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                6, false, IDS_LEADERBOARD_FARMING_EASY),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                6, false, IDS_LEADERBOARD_FARMING_NORMAL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                6, false, IDS_LEADERBOARD_FARMING_HARD),  
        },
        {
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(0, false, -1),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false, IDS_LEADERBOARD_KILLS_EASY),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false, IDS_LEADERBOARD_KILLS_NORMAL),  
            UIScene_LeaderboardsMenu::LeaderboardDescriptor(
                7, false, IDS_LEADERBOARD_KILLS_HARD),  
        },
};
    ...
    switch (filtermode) {
        ...
        case IPlatformLeaderboard::eFM_Friends: {
            ...
            m_interface.ReadStats_Friends(
                this, m_currentDifficulty,
                (IPlatformLeaderboard::EStatsType)m_currentLeaderboard,
                uid , m_newEntryIndex, m_newReadSize);
        } break;
        default:
            break;
    }
