...
#include "minecraft/server/Settings.h"
...
#include "minecraft/world/scores/net.minecraft.world.scores.h"
#include "minecraft/world/scores/criteria/net.minecraft.world.scores.criteria.h"
