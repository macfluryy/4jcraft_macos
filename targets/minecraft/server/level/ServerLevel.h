...
private:
    ...
    std::recursive_mutex m_tickNextTickCS;  
    ...
    std::vector<Pos*> m_queuedSendTileUpdates;  
...
private:
    ...
    int emptyTime;
    bool m_bAtLeastOnePlayerSleeping;  
...
public:
    ...
    bool atEntityLimit(std::shared_ptr<Entity> e);  
