...
void SkeletonHeadModel::setupAnim(float time, float r, float bob, float yRot, float xRot, float scale, unsigned int uiBitmaskOverrideAnim)
{
	Model::setupAnim(time, r, bob, yRot, xRot, scale, uiBitmaskOverrideAnim);
