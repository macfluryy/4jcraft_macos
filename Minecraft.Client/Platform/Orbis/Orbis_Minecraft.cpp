...
void DefineActions(void) {
    ...
    InputManager.SetGameJoypadMaps(
        ...
        _PS4_JOY_BUTTON_DPAD_UP | _PS4_JOY_BUTTON_LSTICK_UP);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_0, ACTION_MENU_DOWN,
        _PS4_JOY_BUTTON_DPAD_DOWN | _PS4_JOY_BUTTON_LSTICK_DOWN);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_0, ACTION_MENU_LEFT,
        _PS4_JOY_BUTTON_DPAD_LEFT | _PS4_JOY_BUTTON_LSTICK_LEFT);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_0, ACTION_MENU_RIGHT,
        _PS4_JOY_BUTTON_DPAD_RIGHT | _PS4_JOY_BUTTON_LSTICK_RIGHT);
    ...
    InputManager.SetGameJoypadMaps(MAP_STYLE_0, MINECRAFT_ACTION_CRAFTING,
                                   _PS4_JOY_BUTTON_SQUARE);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_0, MINECRAFT_ACTION_RENDER_THIRD_PERSON, _PS4_JOY_BUTTON_L3);
    InputManager.SetGameJoypadMaps(MAP_STYLE_0, MINECRAFT_ACTION_GAME_INFO,
                                   _PS4_JOY_BUTTON_TOUCHPAD);
    ...
    InputManager.SetGameJoypadMaps(MAP_STYLE_1, MINECRAFT_ACTION_CRAFTING,
                                   _PS4_JOY_BUTTON_SQUARE);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_1, MINECRAFT_ACTION_RENDER_THIRD_PERSON, _PS4_JOY_BUTTON_R3);
    ...
    InputManager.SetGameJoypadMaps(
        ...
        _PS4_JOY_BUTTON_DPAD_UP | _PS4_JOY_BUTTON_L1);
    ...
    InputManager.SetGameJoypadMaps(MAP_STYLE_2, MINECRAFT_ACTION_CRAFTING,
                                   _PS4_JOY_BUTTON_SQUARE);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_2, MINECRAFT_ACTION_RENDER_THIRD_PERSON, _PS4_JOY_BUTTON_L3);
    ...
    if (InputManager.IsCircleCrossSwapped()) {
        InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_A,
                                       _PS4_JOY_BUTTON_O);
        InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OK,
                                       _PS4_JOY_BUTTON_O);
        InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_B,
                                       _PS4_JOY_BUTTON_X);
        InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_CANCEL,
                                       _PS4_JOY_BUTTON_X);
    } else {
        InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_A,
                                       _PS4_JOY_BUTTON_X);
    ...
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_X,
                                   _PS4_JOY_BUTTON_SQUARE);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_Y,
                                   _PS4_JOY_BUTTON_TRIANGLE);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, ACTION_MENU_UP,
        _PS4_JOY_BUTTON_DPAD_UP | _PS4_JOY_BUTTON_LSTICK_UP);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, ACTION_MENU_DOWN,
        _PS4_JOY_BUTTON_DPAD_DOWN | _PS4_JOY_BUTTON_LSTICK_DOWN);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, ACTION_MENU_LEFT,
        _PS4_JOY_BUTTON_DPAD_LEFT | _PS4_JOY_BUTTON_LSTICK_LEFT);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, ACTION_MENU_RIGHT,
        _PS4_JOY_BUTTON_DPAD_RIGHT | _PS4_JOY_BUTTON_LSTICK_RIGHT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_PAUSEMENU,
                                   _PS4_JOY_BUTTON_OPTIONS);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OTHER_STICK_UP,
                                   _PS4_JOY_BUTTON_RSTICK_UP);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OTHER_STICK_DOWN,
                                   _PS4_JOY_BUTTON_RSTICK_DOWN);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OTHER_STICK_LEFT,
                                   _PS4_JOY_BUTTON_RSTICK_LEFT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OTHER_STICK_RIGHT,
                                   _PS4_JOY_BUTTON_RSTICK_RIGHT);

    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_PAGEUP,
                                   _PS4_JOY_BUTTON_L2);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_PAGEDOWN,
                                   _PS4_JOY_BUTTON_R2);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_RIGHT_SCROLL,
                                   _PS4_JOY_BUTTON_R1);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_LEFT_SCROLL,
                                   _PS4_JOY_BUTTON_L1);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_STICK_PRESS,
                                   _PS4_JOY_BUTTON_L3);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_OTHER_STICK_PRESS,
                                   _PS4_JOY_BUTTON_R3);

    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_JUMP,
                                   _PS4_JOY_BUTTON_X);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_FORWARD,
                                   _PS4_JOY_BUTTON_LSTICK_UP);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_BACKWARD,
                                   _PS4_JOY_BUTTON_LSTICK_DOWN);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_LEFT,
                                   _PS4_JOY_BUTTON_LSTICK_LEFT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_RIGHT,
                                   _PS4_JOY_BUTTON_LSTICK_RIGHT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_LOOK_LEFT,
                                   _PS4_JOY_BUTTON_RSTICK_LEFT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_LOOK_RIGHT,
                                   _PS4_JOY_BUTTON_RSTICK_RIGHT);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_LOOK_UP,
                                   _PS4_JOY_BUTTON_RSTICK_UP);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_LOOK_DOWN,
                                   _PS4_JOY_BUTTON_RSTICK_DOWN);

    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_INVENTORY,
                                   _PS4_JOY_BUTTON_TRIANGLE);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_PAUSEMENU,
                                   _PS4_JOY_BUTTON_OPTIONS);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_DROP,
                                   _PS4_JOY_BUTTON_O);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_CRAFTING,
                                   _PS4_JOY_BUTTON_SQUARE);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_GAME_INFO,
                                   _PS4_JOY_BUTTON_TOUCHPAD);

    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_USE,
                                   _PS4_JOY_BUTTON_L1);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, MINECRAFT_ACTION_ACTION,
                                   _PS4_JOY_BUTTON_R1);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, MINECRAFT_ACTION_RIGHT_SCROLL,
        _PS4_JOY_BUTTON_R2 | _PS4_JOY_BUTTON_DPAD_RIGHT);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, MINECRAFT_ACTION_LEFT_SCROLL,
        _PS4_JOY_BUTTON_L2 | _PS4_JOY_BUTTON_DPAD_LEFT);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, MINECRAFT_ACTION_RENDER_THIRD_PERSON,
        _PS4_JOY_BUTTON_L3 | _PS4_JOY_BUTTON_DPAD_UP);
    InputManager.SetGameJoypadMaps(
        MAP_STYLE_3, MINECRAFT_ACTION_SNEAK_TOGGLE,
        _PS4_JOY_BUTTON_R3 | _PS4_JOY_BUTTON_DPAD_DOWN);

    // Touchpad mapping
    InputManager.SetGameJoypadMaps(MAP_STYLE_0, ACTION_MENU_TOUCHPAD_PRESS,
                                   _PS4_JOY_BUTTON_TOUCHPAD);
    InputManager.SetGameJoypadMaps(MAP_STYLE_1, ACTION_MENU_TOUCHPAD_PRESS,
                                   _PS4_JOY_BUTTON_TOUCHPAD);
    InputManager.SetGameJoypadMaps(MAP_STYLE_2, ACTION_MENU_TOUCHPAD_PRESS,
                                   _PS4_JOY_BUTTON_TOUCHPAD);
    InputManager.SetGameJoypadMaps(MAP_STYLE_3, ACTION_MENU_TOUCHPAD_PRESS,
                                   _PS4_JOY_BUTTON_TOUCHPAD);

    // Partial mapping for Vita TV (applied over other mappings)

    InputManager.SetGameJoypadMaps(PARTIAL_MAP_1, MINECRAFT_ACTION_GAME_INFO,
                                   _PS4_JOY_BUTTON_DPAD_UP);
}
...
void RegisterAwardsWithProfileManager() {
    ...
    ProfileManager.SetRichPresenceSettingFn(
        SQRNetworkManager_Orbis::SetRichPresence);
...
int main(int argc, const char* argv[]) {
    ...
    switch (app.GetProductSKU()) {
        ...
        case e_sku_SCEE:
            ...
            // PG rating has no age, but for some reason the testers are saying
            // it's 8
    ...
    StorageManager.SetSaveTitleExtraFileSuffix(
        app.GetString(IDS_SAVE_SUBTITLE_SUFFIX));
    ...
    // looks like the PS4 controller is a good bit more sensitive than PS3.
    // Defaults in the lib are 10000 for deadzone and 32767 for movement range
    ...
    ProfileManager.Initialise(
        &commsId,   // SQRNetworkManager::GetSceNpCommsId(),
    ...
    // register the get string function with the profile lib, so it can be
    ...
    StorageManager.SetCorruptSaveName(
        (WCHAR*)app.GetString(IDS_CORRUPTSAVE_TITLE));
#if (defined _FINAL_BUILD) || (defined _ART_BUILD)
    StorageManager.SetGameSaveFolderPrefix(app.GetSaveFolderPrefix());
#else
    // Use debug directory to prevent debug saves being loaded/edited in package
    // build (since debug can't edit package save games this causes various
    // problems)
    ...
    byteArray baOptionsIcon =
        app.getArchiveFile(L"DefaultOptionsImage228x128.png");
    ...
    // Temporary - set a single user for quadrant 0 for the storage manager.
    // Will need to do more to link this aspect of the storage manager is once
    // we have proper profile management.
...
#pragma message(__LOC__ "Need to define the _FINAL_BUILD before submission")
    ...
    // 4J-PB - Moved here because it crashed when the network init was called if
    // left where it was before. We should track down why though...
    ...
    while (TRUE) {
        ...
        for (int i = 0; i < XUSER_MAX_COUNT; i++) {
            if (bOptionsNoSpace == false) {
                if (app.GetOptionsCallbackStatus(i) ==
                    C4JStorage::eOptions_Callback_Write_Fail_NoSpace) {
                    // get the game to bring up the save space handling
                    bOptionsNoSpace = true;
                    app.SetOptionsCallbackStatus(
                        i, C4JStorage::eOptions_Callback_Idle);
