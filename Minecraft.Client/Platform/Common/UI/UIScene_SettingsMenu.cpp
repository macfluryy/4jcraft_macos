...
UIScene_SettingsMenu::UIScene_SettingsMenu(int iPad, void* initData,
    ...
    m_buttons[BUTTON_ALL_OPTIONS].init(app.GetString(IDS_OPTIONS),
                                       BUTTON_ALL_OPTIONS);
    m_buttons[BUTTON_ALL_AUDIO].init(app.GetString(IDS_AUDIO),
                                     BUTTON_ALL_AUDIO);
    m_buttons[BUTTON_ALL_CONTROL].init(app.GetString(IDS_CONTROL),
                                       BUTTON_ALL_CONTROL);
    m_buttons[BUTTON_ALL_GRAPHICS].init(app.GetString(IDS_GRAPHICS),
                                        BUTTON_ALL_GRAPHICS);
    m_buttons[BUTTON_ALL_UI].init(app.GetString(IDS_USER_INTERFACE),
                                  BUTTON_ALL_UI);
    m_buttons[BUTTON_ALL_RESETTODEFAULTS].init(
        app.GetString(IDS_RESET_TO_DEFAULTS), BUTTON_ALL_RESETTODEFAULTS);
