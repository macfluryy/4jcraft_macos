...
//--------------------------------------------------------------------------------------
class CXuiSceneBrewingStand : public CXuiSceneAbstractContainer,
                              public IUIScene_BrewingMenu {
public:
    // Define the class. The class name must match the ClassOverride property
    // set for the scene in the UI Authoring tool.
    XUI_IMPLEMENT_CLASS(CXuiSceneBrewingStand, L"CXuiSceneBrewingStand",
                        XUI_CLASS_SCENE)
...
protected:
    ...
    HRESULT OnDestroy();
    //	HRESULT OnCustomMessage_Splitscreenplayer(bool bJoining, BOOL&
    //bHandled);
