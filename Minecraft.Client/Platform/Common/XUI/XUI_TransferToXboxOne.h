...
public:
    ...
    XUI_IMPLEMENT_CLASS(CScene_TransferToXboxOne, L"CScene_TransferToXboxOne",
                        XUI_CLASS_SCENE)

    static int TMSPPSlotListReturned(LPVOID pParam, int iPad, int iUserData,
...
private:
    HRESULT BuildSlotFile(int iIndexBeingUpdated, PBYTE pbImageData,
                          DWORD dwImageBytes);
