...
//----------------------------------------------------------------------------------
HRESULT CScene_InGamePlayerOptions::OnInit(XUIMessageInit* pInitData,
                                           BOOL& bHandled) {
    m_iPad = *(int*)pInitData->pvInitData;

    InGamePlayerOptionsInitData* initData =
        (InGamePlayerOptionsInitData*)pInitData->pvInitData;
    ...
    if (m_editingSelf || trustPlayers || editingPlayer->IsHost()) {
        ...
        m_checkboxes[eControl_BuildAndMine].SetText(
            app.GetString(IDS_CAN_BUILD_AND_MINE));
        ...
        m_checkboxes[eControl_UseDoorsAndSwitches].SetText(
        ...
        m_checkboxes[eControl_UseContainers].SetText(
            app.GetString(IDS_CAN_OPEN_CONTAINERS));
        m_checkboxes[eControl_UseContainers].SetCheck(checked);

        checked = Player::getPlayerGamePrivilege(
                      m_playerPrivileges,
                      Player::ePlayerGamePrivilege_CannotAttackPlayers) == 0;
        m_checkboxes[eControl_AttackPlayers].SetText(
            app.GetString(IDS_CAN_ATTACK_PLAYERS));
        m_checkboxes[eControl_AttackPlayers].SetCheck(checked);

        checked = Player::getPlayerGamePrivilege(
                      m_playerPrivileges,
                      Player::ePlayerGamePrivilege_CannotAttackAnimals) == 0;
        m_checkboxes[eControl_AttackAnimals].SetText(
            app.GetString(IDS_CAN_ATTACK_ANIMALS));
    ...
    if (m_editingSelf) {
     ...
     defined(_FINAL_BUILD) && !defined(_DEBUG_MENUS_ENABLED))
        ...
        m_checkboxes[eControl_Op].SetCheck(Player::getPlayerGamePrivilege(
        ...
        if (cheats) {
            ...
            m_checkboxes[eControl_HostInvisible].SetText(
                app.GetString(IDS_INVISIBLE));
            ...
            if (inCreativeMode) {
                ...
                m_checkboxes[eControl_HostFly].SetText(
                    app.GetString(IDS_CAN_FLY));
                ...
                m_checkboxes[eControl_HostHunger].SetText(
                    app.GetString(IDS_DISABLE_EXHAUSTION));
        ...
        if (localPlayer->IsHost()) {
            ...
            m_checkboxes[eControl_Op].SetCheck(
                Player::getPlayerGamePrivilege(
        ...
        if (localPlayer->IsHost() && cheats) {
            ...
            bool checked =
                Player::getPlayerGamePrivilege(
                    ...
                    Player::ePlayerGamePrivilege_CanToggleInvisible) != 0;
            m_checkboxes[eControl_HostInvisible].SetText(
                app.GetString(IDS_CAN_INVISIBLE));
            m_checkboxes[eControl_HostInvisible].SetCheck(checked);
            ...
            m_checkboxes[eControl_CheatTeleport].SetText(
                app.GetString(IDS_ENABLE_TELEPORT));
    ...
    g_NetworkManager.RegisterPlayerChangedCallback(
        m_iPad, &CScene_InGamePlayerOptions::OnPlayerChanged, this);
...
HRESULT CScene_InGamePlayerOptions::OnKeyDown(XUIMessageInput* pInputData,
                                              BOOL& rfHandled) {
     ...
     defined(_FINAL_BUILD) && !defined(_DEBUG_MENUS_ENABLED))
                ...
                if (cheats) {
                    ...
                    if (canBeInvisible)
                        Player::setPlayerGamePrivilege(
                            ...
                            m_checkboxes[eControl_HostInvisible].IsChecked());
                    if (canBeInvisible)
                        Player::setPlayerGamePrivilege(
                            m_playerPrivileges,
                ...
                if (!trustPlayers &&
                    ...
                    Player::setPlayerGamePrivilege(
                        ...
                        m_checkboxes[eControl_UseDoorsAndSwitches].IsChecked());
                    Player::setPlayerGamePrivilege(
                        m_playerPrivileges,
                ...
                if (localPlayer->IsHost()) {
                    if (cheats) {
                        ...
                        Player::setPlayerGamePrivilege(
                            ...
                            m_checkboxes[eControl_CheatTeleport].IsChecked());
                    }
...
HRESULT CScene_InGamePlayerOptions::OnNotifyPressEx(
    ...
    if (hObjPressed == m_buttonKick) {
        ...
        *smallId = m_networkSmallId;
        ...
        StorageManager.RequestMessageBox(
            ...
            m_iPad, &CScene_InGamePlayerOptions::KickPlayerReturned, smallId,
            app.GetStringTable());
...
HRESULT CScene_InGamePlayerOptions::OnControlNavigate(
...
int CScene_InGamePlayerOptions::KickPlayerReturned(
...
void CScene_InGamePlayerOptions::OnPlayerChanged(void* callbackParam,
                                                 INetworkPlayer* pPlayer,
                                                 bool leaving) {
    CScene_InGamePlayerOptions* scene =
        (CScene_InGamePlayerOptions*)callbackParam;
...
HRESULT CScene_InGamePlayerOptions::OnTransitionStart(
...
void CScene_InGamePlayerOptions::removeControl(HXUIOBJ hObjToRemove,
                                               bool center) {
    D3DXVECTOR3 pos;
...
void CScene_InGamePlayerOptions::resetCheatCheckboxes() {
    ...
    if (!m_editingSelf) {
        ...
        m_checkboxes[eControl_HostInvisible].SetCheck(
            isModerator &&
            (Player::getPlayerGamePrivilege(
                 m_playerPrivileges,
                 Player::ePlayerGamePrivilege_CanToggleInvisible) != 0));
        ...
        // NOT CREATIVE MODE.
        {
            ...
            m_checkboxes[eControl_HostFly].SetCheck(
                isModerator &&
                (Player::getPlayerGamePrivilege(
                     m_playerPrivileges,
                     Player::ePlayerGamePrivilege_CanToggleFly) != 0));
            ...
            m_checkboxes[eControl_HostHunger].SetCheck(
                isModerator &&
                (Player::getPlayerGamePrivilege(
                     m_playerPrivileges,
                     Player::ePlayerGamePrivilege_CanToggleClassicHunger) !=
        ...
        m_checkboxes[eControl_CheatTeleport].SetCheck(
            isModerator &&
            (Player::getPlayerGamePrivilege(
                 m_playerPrivileges,
                 Player::ePlayerGamePrivilege_CanTeleport) != 0));
