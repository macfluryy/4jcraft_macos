...
HRESULT CScene_SignEntry::OnInit(XUIMessageInit* pInitData, BOOL& bHandled) {
    ...
    SignEntryScreenInput* initData =
        (SignEntryScreenInput*)pInitData->pvInitData;
...
HRESULT CScene_SignEntry::OnNotifyPressEx(HXUIOBJ hObjPressed,
...
HRESULT CScene_SignEntry::OnKeyDown(XUIMessageInput* pInputData,
                                    BOOL& rfHandled) {
