...
//--------------------------------------------------------------------------------------
class CXuiSceneInventoryCreative : public CXuiSceneAbstractContainer,
                                   public IUIScene_CreativeMenu {
public:
    // Define the class. The class name must match the ClassOverride property
    // set for the scene in the UI Authoring tool.
    XUI_IMPLEMENT_CLASS(CXuiSceneInventoryCreative,
                        L"CXuiSceneInventoryCreative", XUI_CLASS_SCENE)
