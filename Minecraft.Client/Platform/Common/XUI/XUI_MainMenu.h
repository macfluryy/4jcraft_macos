...
public:
    ...
    static int CreateLoad_SignInReturned(void* pParam, bool bContinue,
                                         int iPad);
    static int CreateLoad_OfflineProfileReturned(void* pParam, bool bContinue,
                                                 int iPad);
    ...
    static int MustSignInReturned(void* pParam, int iPad,
                                  C4JStorage::EMessageResult result);
#ifdef _XBOX
    static int TMSReadFileListReturned(
    ...
    static int TMSFileReadReturned(void* pParam, int iPad,
