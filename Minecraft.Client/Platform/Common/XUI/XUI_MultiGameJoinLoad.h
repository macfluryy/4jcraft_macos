...
public:
    ...
    XUI_IMPLEMENT_CLASS(CScene_MultiGameJoinLoad, L"CScene_MultiGameJoinLoad",
                        XUI_CLASS_SCENE)
...
private:
    ...
    static void SearchForGameCallback(void* hObj, DWORD dwNumResults,
    ...
    // callback
#ifdef _XBOX
    static bool GetSavesInfoCallback(LPVOID pParam, int iInstalledC,
                                     C4JStorage::CACHEINFOSTRUCT* InfoA,
                                     int iPad, HRESULT hRes);
#else
    ...
    static void StartGameFromSave(CScene_MultiGameJoinLoad* pClass,
    ...
    static void UploadFile(CScene_MultiGameJoinLoad* pClass, char* filename,
