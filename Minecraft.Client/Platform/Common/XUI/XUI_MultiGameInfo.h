...
protected:
    ...
    CXuiControl m_difficulty, m_GameType, m_gamertagsOn, m_structuresOn,
        m_levelType, m_pvpOn, m_trustPlayers, m_tntOn, m_fireOn;
    CXuiControl m_labelDifficulty, m_labelGameType, m_labelGamertagsOn,
        m_labelStructuresOn, m_labelLevelType, m_labelPvP, m_labelTrust,
        m_labelTNTOn, m_labelFireOn;
...
public:
    ...
    XUI_IMPLEMENT_CLASS(CScene_MultiGameInfo, L"CScene_MultiGameInfo",
                        XUI_CLASS_SCENE)
