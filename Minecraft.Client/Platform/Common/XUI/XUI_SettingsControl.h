...
protected:
    ...
    BEGIN_CONTROL_MAP()
    MAP_CONTROL(IDC_XuiSliderSensitivityInGame,
                m_SliderA[SLIDER_SETTINGS_SENSITIVITY_INGAME])
    MAP_CONTROL(IDC_XuiSliderSensitivityInMenu,
                m_SliderA[SLIDER_SETTINGS_SENSITIVITY_INMENU])
    END_CONTROL_MAP()
...
public:
    ...
    XUI_IMPLEMENT_CLASS(CScene_SettingsControl, L"CScene_SettingsControl",
                        XUI_CLASS_SCENE)
};
