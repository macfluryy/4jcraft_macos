...
HRESULT CXuiSceneFurnace::OnInit(XUIMessageInit* pInitData, BOOL& bHandled) {
    ...
    CXuiSceneAbstractContainer::Initialize(
        m_iPad, menu, true, FurnaceMenu::INV_SLOT_START, eSectionFurnaceUsing,
        eSectionFurnaceMax);
...
void CXuiSceneFurnace::InitDataAssociations(int iPad,
    ...
    CXuiSceneAbstractContainer::InitDataAssociations(
        iPad, menu, FurnaceMenu::INV_SLOT_START);
}
